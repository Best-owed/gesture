...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default= "weights/yolov5m-seg.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="models/yolov5m.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default="mydata/config.yaml", help="dataset.yaml path")
